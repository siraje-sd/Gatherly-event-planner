...
export const LogoIcon = ({ className = '', dark = false }) => (
  <svg
    viewBox="0 0 100 100"
    fill="none"
    xmlns="http://www.w3.org/2000/svg"
    className={className}
    aria-label="Gatherly Icon"
  >
    <defs>
    ...
    <rect x="20" y="15" width="60" height="70" rx="8" fill="url(#iconGradient)" />
    ...
    <path d="M 50 70 L 50 80 M 45 75 L 55 75" stroke="url(#iconGradient)" strokeWidth="2.5" strokeLinecap="round" />
  </svg>
);
